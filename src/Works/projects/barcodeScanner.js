...
export default {
  ...
  description: `An application for scanning and managing barcode, easy to scan and create EAN13 barcodes with this application.`,
  tags: [tech.cordova, tech.wordpress, tech.php],
  images: [
    "/img/projects/barcodescanner/1.png",
    "/img/projects/barcodescanner/2.png",
    "/img/projects/barcodescanner/3.png",
